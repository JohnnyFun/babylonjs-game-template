...
def processImage(path, name):
	...
	splitAndSave(img, 0, 0, size, addToFilename(name, "_px")) # "_right"))
	splitAndSave(img, size, 0, size, addToFilename(name, "_nz")) # "_back"))
	splitAndSave(img, size * 2, 0, size, addToFilename(name, "_nx")) # "_left"))
	splitAndSave(img, 0, size, size, addToFilename(name, "_ny")) # "_down"))
	splitAndSave(img, size, size, size, addToFilename(name, "_py")) # "_up"))
	splitAndSave(img, size * 2, size, size, addToFilename(name, "_pz")) # "_front"))
